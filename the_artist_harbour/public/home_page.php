    ...
    <div class="container-fluid">
        ...
        <div class="row g-0">
            <div class="col-12 text-center">
                ...
                <h3>We are a collective working to make a safe and community-based space for artists to market their
                    bespoke services</h3>
            </div>
        </div>
    </div>
                        ...
                        <div class="card hovercard text-center">
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="card-subtitle">
                                    <?php echo ServiceDetails::getServicePrice($service['min_price'], $service['max_price']) . "\n"; ?>
                                </h4>
