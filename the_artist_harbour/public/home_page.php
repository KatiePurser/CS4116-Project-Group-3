    ...
    <div class="container-fluid">
        ...
        <div class="row g-0">
            <div class="home-heading">
                ...
                <h3 class="home-description">We are a collective working to make a safe and community-based space for
                    artists to market their bespoke services</h3>
            </div>
        </div>
    </div>
                        ...
                        <div class="service-item">
                            <div class="service-image">
                                <?php if (!empty($service['image'])) { ?>
                                    <img src="../features/business/get_serviceImage.php?id=<?= $service['id'] ?>"
