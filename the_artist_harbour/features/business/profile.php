...
.btn-outline-purple:hover {
    ...
    .modal-content {
    background-color: #f5f0ff; /* Light purple background for modal body */
    border: none;
    border-radius: 12px;
}

.modal-header {
    background-color: #82689A; /* Dark purple background for modal header */
...
.modal-footer {
    ...
    background-color: #f5f0ff; /* Light purple background for modal footer */
            ...
            <div class="card-body p-4">
                <div class="row">
                    ...
                    <div class="col-md-3 text-center mb-3 mb-md-0">
                        <?php if ($user_id): ?>
                            <img src="../user/get_image.php?id=<?php echo $user_id; ?>" alt="Profile Picture" class="rounded-circle img-fluid profile-img">
                        <?php else: ?>
                            <img src="../../public/images/user_icon.svg" alt="Default Profile" class="rounded-circle img-fluid profile-img">
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="col-md-9">
                        ...
                        <p class="text-muted mb-2">Owned by <?php echo htmlspecialchars($owner_first_name . ' ' . $owner_last_name); ?></p>
                        ...
                        <div class="mb-3">
                            <div class="d-inline-block bg-light-purple rounded-pill px-3 py-2">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span><?php echo number_format($avg_rating, 1); ?> out of 5 (<?php echo $total_reviews; ?> reviews)</span>
                                </div>
                            </div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="service-item">
                            <div class="service-image">
                                <?php if (!empty($service['image'])): ?>
                                    <img src="./get_serviceImage.php?id=<?= $service['id'] ?>" alt="<?php echo htmlspecialchars($service['name']); ?>">
                                <?php else: ?>
                            ...
                            <div class="service-details">
                                ...
                                <div class="service-meta">
                                    ...
                                    <a href="#" class="request-btn">Request</a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
...
<div class="reviews-section">
    <div class="reviews-header">
        ...
        <div class="sort-options">
            <a href="?business_id=<?php echo $business_id; ?>&sort=newest" class="sort-btn <?php echo $sort_by === 'newest' ? 'active' : ''; ?>">
                Newest
            </a>
            <a href="?business_id=<?php echo $business_id; ?>&sort=highest" class="sort-btn <?php echo $sort_by === 'highest' ? 'active' : ''; ?>">
                Highest Rating
            </a>
            <a href="?business_id=<?php echo $business_id; ?>&sort=lowest" class="sort-btn <?php echo $sort_by === 'lowest' ? 'active' : ''; ?>">
                Lowest Rating
            </a>
        </div>
        <?php endif; ?>
            ...
            <div class="pagination-container">
                <ul class="pagination">
                    <?php if ($review_page > 1): ?>
                        <li><a href="?business_id=<?php echo $business_id; ?>&review_page=<?php echo $review_page - 1; ?>&sort=<?php echo $sort_by; ?>">&laquo; Previous</a></li>
                    <?php endif; ?>
                    
                    <?php for ($i = 1; $i <= $total_review_pages; $i++): ?>
                        <li>
                            <a href="?business_id=<?php echo $business_id; ?>&review_page=<?php echo $i; ?>&sort=<?php echo $sort_by; ?>" <?php echo $i === $review_page ? 'class="active"' : ''; ?>>
                                <?php echo $i; ?>
                            </a>
                        </li>
                    <?php endfor; ?>
                    ...
                    <?php if ($review_page < $total_review_pages): ?>
                        <li><a href="?business_id=<?php echo $business_id; ?>&review_page=<?php echo $review_page + 1; ?>&sort=<?php echo $sort_by; ?>">Next &raquo;</a></li>
                    <?php endif; ?>
                </ul>
            </div>
        <?php endif; ?>
...
<!-- Flag Review Modal -->
<div class="modal fade" id="flagReviewModal" tabindex="-1" aria-labelledby="flagReviewModalLabel" aria-hidden="true">
            ...
            <form id="flagReviewForm" action="../reviews/flag_review.php" method="post">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="flag_details" name="flag_details" rows="3"></textarea>
                    </div>
                </div>
...
<?php if ($_SESSION['user_type'] === 'customer'): ?>
<div class="modal fade" id="insightRequestModal" tabindex="-1" aria-labelledby="insightRequestModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
