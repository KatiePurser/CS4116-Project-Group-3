    ...
    <div class="row g-0 filter-container" style="background-color: #E2D4F0; text-align: center;">
        ...
        <form action="search_page.php" method="get">
            ...
            <select class="rating" name="rating" id="rating">
                <option value="" disabled <?php if ((!isset($_GET['rating'])) || ((isset($_GET['rating']) && $_GET['rating'] == "6")))
                    echo "selected"; ?> hidden>Filter By Reviews</option>
                <option value="0" <?php if (isset($_GET['rating']) && $_GET['rating'] == "0")
                    echo "selected"; ?>>0 Stars
                </option>
                <option value="1" <?php if (isset($_GET['rating']) && $_GET['rating'] == "1")
                    echo "selected"; ?>>1 Star
                </option>
                <option value="2" <?php if (isset($_GET['rating']) && $_GET['rating'] == "2")
                    echo "selected"; ?>>2 Stars
                </option>
                <option value="3" <?php if (isset($_GET['rating']) && $_GET['rating'] == "3")
                    echo "selected"; ?>>3 Stars
                </option>
                <option value="4" <?php if (isset($_GET['rating']) && $_GET['rating'] == "4")
                    echo "selected"; ?>>4 Stars
                </option>
                <option value="5" <?php if (isset($_GET['rating']) && $_GET['rating'] == "5")
                    echo "selected"; ?>>5 Stars
                </option>
                <option value="6">Remove Selection</option>
            </select>
            <!-- apply an ordering method -->
            <select class="filter" name="filter" id="filter">
                <option value="" disabled <?php if ((!isset($_GET['filter'])) || ((isset($_GET['filter']) && $_GET['filter'] == "5")))
                    echo "selected"; ?> hidden>Sort Services</option>
                <option value="1" <?php if (isset($_GET['filter']) && $_GET['filter'] == "1")
                    echo "selected"; ?>>By
                    Reviews (High to Low)</option>
                <option value="2" <?php if (isset($_GET['filter']) && $_GET['filter'] == "2")
                    echo "selected"; ?>>By
                    Reviews (Low to High)</option>
                <option value="3" <?php if (isset($_GET['filter']) && $_GET['filter'] == "3")
                    echo "selected"; ?>>By Price
                    (High to Low)</option>
            ...
            if ($services == NULL) {
                ...
                <?php if ($total_service_pages > 1) { ?>
                    <div class="pagination-container">
                        <ul class="pagination">
                            <?php if ($page > 1) { ?>
                                <li><a href="?search=<?php echo $_GET['search'] ?>&page=<?php echo $page - 1; ?>">&laquo;
                                        Previous</a></li>
                            <?php } ?>
                            ...
                            <?php if ($page < $total_service_pages) { ?>
                                <li><a href="?search=<?php echo $_GET['search'] ?>&page=<?php echo $page + 1; ?>">Next &raquo;</a>
                                </li>
                            <?php }
                            ; ?>
                        </ul>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content shadow-lg rounded-4">
                <div class="modal-header text-white rounded-top-4">
                    ...
                    <button class="btn-close btn-close-white me-2" data-bs-dismiss="modal"
