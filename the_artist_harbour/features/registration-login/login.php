        ...
        <div class="row">
            <div class="col-12">
                <form method="post" action="loginUser.php" class="w-100">
                    <div class="mb-3">
                        <label for="login-email" class="form-label">Email Address <span
                                class="text-danger">*</span></label>
                        <input type="email" name="email" placeholder="Enter your Email Address"
                            value="<?php echo $_SESSION['email_address'] ?? ''; ?>" required id="login-email"
                            class="form-control">
                    </div>
                    <div class="mb-3">
                        <label for="login-password" class="form-label">Password <span
                                class="text-danger">*</span></label>
                        <div class="input-group">
                            <input type="password" name="password" placeholder="Enter your Password"
                                value="<?php echo $_SESSION['password'] ?? ''; ?>" required id="login-password"
                                class="form-control">
