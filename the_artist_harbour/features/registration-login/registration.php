                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" name="email" placeholder="Enter your Email Address"
                                            value="<?php echo $_SESSION['customer_email_address'] ?? ''; ?>" required
                                            id="customer-email" class="form-control">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="first_name" placeholder="Enter your First Name"
                                            value="<?php echo $_SESSION['customer_first_name'] ?? ''; ?>" required
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="last_name" placeholder="Enter your Last Name"
                                            value="<?php echo $_SESSION['customer_last_name'] ?? ''; ?>" required
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="password" name="password" placeholder="Enter your Password"
                                                value="<?php echo $_SESSION['customer_password'] ?? ''; ?>" required
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="password" name="confirm_password"
                                                ...
                                                value="<?php echo $_SESSION['customer_confirm_password'] ?? ''; ?>"
                                                required id="customer-confirm-password" class="form-control">
                                            <span class="input-group-text" style="cursor: pointer;"><i
                                                    class="bi bi-eye-slash"></i></span>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="business-email" class="form-label">Email Address <span
                                                class="text-danger">*</span></label>
                                        <input type="email" name="email" placeholder="Enter your Email Address"
                                            value="<?php echo $_SESSION['business_email_address'] ?? ''; ?>" required
                                    ...
                                    <div class="mb-3">
                                        <label for="business-first-name" class="form-label">First Name <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="first_name" placeholder="Enter your First Name"
                                            value="<?php echo $_SESSION['business_first_name'] ?? ''; ?>" required
                                            id="business-first-name" class="form-control">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <label for="business-last-name" class="form-label">Last Name <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="last_name" placeholder="Enter your Last Name"
                                            value="<?php echo $_SESSION['business_last_name'] ?? ''; ?>" required
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="business_name" placeholder="Enter your Business Name"
                                            value="<?php echo $_SESSION['business_business_name'] ?? ''; ?>" required
                                            id="business-name" class="form-control">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="password" name="password" placeholder="Enter your Password"
                                                value="<?php echo $_SESSION['business_password'] ?? ''; ?>" required
                                                id="business-password" class="form-control">
                                            <span class="input-group-text" style="cursor: pointer;"><i
                                                    class="bi bi-eye-slash"></i></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="password" name="confirm_password"
                                                placeholder="Confirm your Password"
                                                value="<?php echo $_SESSION['business_confirm_password'] ?? ''; ?>"
                                                required id="business-confirm-password" class="form-control">
                                            <span class="input-group-text" style="cursor: pointer;"><i
                                                    class="bi bi-eye-slash"></i></span>
                                        </div>
                                    </div>
